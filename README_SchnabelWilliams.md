...
The movement system is the most complex part of the code and is primarily how we implement 
different tactics for 1v1 vs melee. We created a hybrid movement system using "antigravity" 
(which uses repulsive forces that "push" the bot away from walls and enemies) and a more fixed,
...
The bot also tracks recently scanned enemies in an array. The antigravity system uses the array to
calculate repulsive forces, which prevents VanJeckylson from driving directly into crowded areas.
